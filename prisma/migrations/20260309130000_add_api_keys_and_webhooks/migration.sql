...
-- CreateIndex
CREATE INDEX "WebhookEndpoint_userId_createdAt_idx" ON "WebhookEndpoint"("userId", "createdAt");

-- CreateIndex
CREATE INDEX "WebhookEndpoint_userId_revokedAt_idx" ON "WebhookEndpoint"("userId", "revokedAt");
